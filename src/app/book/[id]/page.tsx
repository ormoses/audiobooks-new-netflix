    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-wrap items-center gap-2 md:gap-4 mb-6">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-3 py-2 md:px-0 md:py-0 rounded-lg bg-netflix-gray md:bg-transparent text-netflix-light-gray hover:text-white transition-colors min-h-[44px]"
        >
        ...
        {backToSeriesHref && (
          <>
            <span className="hidden md:inline text-netflix-light-gray/50">|</span>
            <Link
            ...
            >
              ...
              <span className="text-sm md:text-base">Back to Series</span>
            </Link>
          </>
        )}
      </div>
